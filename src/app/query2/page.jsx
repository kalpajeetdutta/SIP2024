  ...
  const processScreenTimeData = data => {
    ...
    data.forEach(child => {
      devices.forEach(device => {
        const timeCategory = child.weekends[device];
  ...
  return (
    <div className="w-full h-full overflow-x-hidden p-5 md:px-10">
      <h1 className="mb-10 text-lg md:text-3xl text-center">
        Query: Graphical representation of weekends screentime % of children on
      ...
      <div className='mt-10 px-5'>
        ...
        <ul className='text-sm md:text-base'>
          <li>
            The highest screentime percentage for children is on TV (46.09%),
            followed by smartphones (36.72%), tablets (14.84%), and laptops
            (2.34%).
          </li>
        </ul>
        ...
        <ul className='text-sm md:text-base'>
          <li className='my-2'>
            Both males and females show the highest screentime on TV. Females have
            a slightly higher percentage (46.88%) compared to males (45.83%).
          </li>
          <li className='my-2'>
            The screentime for smartphones is relatively balanced between
            genders, with females slightly higher (37.50%) than males (36.46%).
          </li>
          <li className='my-2'>
            Laptop usage is the lowest among all devices for both genders, with
            females at 3.13% and males at 2.08%.
          </li>
        </ul>
        <h2 className='text-xl md:text-2xl'>Conclusion</h2>
        <p className='text-sm md:text-base'>
          The data reveals that TV is the most used device by children during
          weekends, followed by smartphones, tablets, and laptops. Gender
